...
if __name__ == "__main__":
    # 配置路径
    data_dir = '/home/phy/lab/executing/pathce/datasets/imdb'
    schema_path = '/home/phy/lab/executing/pathce/schemas/imdb/imdb_gcard_schema.json'
    pattern_path = '/home/phy/lab/executing/pathce/patterns/job'
    file_path = 'safebound_instance_imdb.pkl'
    result_path = 'res/imdb'
    ...
    if not os.path.exists(file_path):
        ...
        with open('safebound_instance_imdb.pkl', 'wb') as f:
